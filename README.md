...
3. **Additional Configurations (if applicable)**  
   For the following projects, update the tsconfig.json file with these lines to ensure proper functionality: appFireBase, appPetCuidador
   ```bash
   {
    "useDefineForClassFields": false, // already included
